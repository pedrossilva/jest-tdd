...
it('filter([1, 2, 3, 2, 1, 5], (item, index, array) => array.indexOf(item) === index) should return [1, 2, 3, 5]', () => {
  expect(filter([1, 2, 3, 2, 1, 5], (item, index, array) => array.indexOf(item) === index)).to.be.deep.equal([1, 2, 3, 5])
})
